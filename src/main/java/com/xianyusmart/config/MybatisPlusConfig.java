...
public class MybatisPlusConfig {
    ...
    private static final Set<String> TENANT_TABLES = Set.of(
            ...
            "growth_resource_version", "growth_resource_goods_mapping", "growth_search_snapshot",
            "growth_workflow_version", "growth_workflow_run", "growth_workflow_node_run",
            "growth_workflow_event", "growth_workflow_action_request",
