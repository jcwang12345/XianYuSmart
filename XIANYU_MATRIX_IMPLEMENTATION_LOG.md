...
- `V6-BUG-005`：备份模块清单、manifest、dry-run、恢复点、回滚和强确认仍需完整开发。
- `V6-BUG-006`：通知收件箱服务端分页/筛选、前端分页或虚拟化和中文状态仍需完整开发。
- 因此本批只声明 V6 证据基线、Wave 2 增量和四项 Gate 0 缺陷闭环，不宣称 V6 或 Gate 0 全部完成。
