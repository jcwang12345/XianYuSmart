...
h2, h3, h4, p { margin: 0; } h2 { margin-top: 2px; font-size: 19px; }.eyebrow { color: #9a6200; font-size: 10px; font-weight: 700; letter-spacing: .08em; }.toolbar p { margin-top: 5px; color: #667085; font-size: 13px; }
