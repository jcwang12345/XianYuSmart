...
当前版本：[2.3.1](https://github.com/jcwang12345/XianYuSmart/tree/v2.3.1) · [查看更新日志](CHANGELOG.md)
...
本分支的 `v2.3.1` 需使用仓库根目录 Dockerfile 本地构建；以下 GHCR 地址仍是上游最后一个公开镜像 `v2.0.7`，不包含本次商品任务中心与矩阵安全状态改造。
